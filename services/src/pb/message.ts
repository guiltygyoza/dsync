...
export namespace DBFinderMessage {
  ...
  export const codec = (): Codec<DBFinderMessage> => {
    if (_codec == null) {
      _codec = message<DBFinderMessage>((obj, w, opts = {}) => {
  ...
  export const decode = (buf: Uint8Array | Uint8ArrayList, opts?: DecodeOptions<DBFinderMessage>): DBFinderMessage => {
...
export namespace FindDBRequest {
  ...
  export const codec = (): Codec<FindDBRequest> => {
    if (_codec == null) {
      _codec = message<FindDBRequest>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
...
export namespace AddDBRequest {
  ...
  export const codec = (): Codec<AddDBRequest> => {
    if (_codec == null) {
      _codec = message<AddDBRequest>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
...
export namespace FindDBResponse {
  ...
  export const codec = (): Codec<FindDBResponse> => {
    if (_codec == null) {
      _codec = message<FindDBResponse>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
...
export namespace AddDBResponse {
  ...
  export const codec = (): Codec<AddDBResponse> => {
    if (_codec == null) {
      _codec = message<AddDBResponse>((obj, w, opts = {}) => {
        if (opts.lengthDelimited !== false) {
          w.fork()
        }
