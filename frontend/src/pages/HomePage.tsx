    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>
            Welcome to the Ethereum Congress, where protocol governance happens through 
            Ethereum Improvement Proposals process.
          </p>
        </div>
      </section>
        ...
        <div className="upcoming-calls">
          ...
          <div className="countdown-floor-container">
            ...
            <div className="enter-floor-container">
              <Link to="/floor" className="enter-floor-button">Enter the Floor</Link>
            </div>
          </div>
            ...
            {upcomingCalls.map(call => (
              <div key={call.id} className="call-card">
                ...
                <div className="call-links">
                  <a href={call.agendaLink} target="_blank" rel="noopener noreferrer">View Agenda</a>
                </div>
                ...
                <tr key={call.id}>
                  ...
                  <td>
                    {call.eipsDiscussed.map((eip, index) => (
                      <Link key={index} to={`/eips/${eip.replace('EIP-', '')}`} className="eip-link">
                        {eip}
      ...
      <section className="quick-nav-section">
        <div className="section-header">
          <h2>Hearing Rooms</h2>
          <div>
            <Link to="/eips" className="view-all">View All EIPs →</Link>
          </div>
        </div>
      ...
      <section className="community-section">
        ...
        <div className="community-links">
          <a href="https://discord.gg/ethereum" target="_blank" rel="noopener noreferrer" className="community-link">
            <div className="community-icon discord"></div>
            <span>Discord</span>
          </a>
          <a href="https://twitter.com/ethereum" target="_blank" rel="noopener noreferrer" className="community-link">
            <div className="community-icon twitter"></div>
            <span>Twitter</span>
          </a>
          <a href="https://github.com/ethereum" target="_blank" rel="noopener noreferrer" className="community-link">
            <div className="community-icon github"></div>
            <span>GitHub</span>
          </a>
          <a href="https://ethereum.org/en/community/" target="_blank" rel="noopener noreferrer" className="community-link">
