...
export type AppMutators = {
	createChamber: (tx: WriteTransaction, args: Omit<Chamber, "id" | "createdAt">) => Promise<void>;
	createComment: (tx: WriteTransaction, args: Omit<Comment, "id" | "createdAt">) => Promise<void>;
